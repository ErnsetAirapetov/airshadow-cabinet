 ...
 * тестов: страницу в тесте не собрать — её граф импортов дотягивается до alias
 * `@/`, а он в тестах не разрешается. Значит либо логика вынесена и проверена,
 * либо не проверена вовсе.
 */
