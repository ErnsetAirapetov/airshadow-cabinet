...
// БЕЗ изменений (задача #29): правлены только пути импортов под
// alias `@/`. Спека владельца на экране покупки трогает единственный
// блок — виджет промо-группы в витрине тарифов, — а классический
// режим продаж обязан работать как прежде: на стенде он не виден, но
// на другой инсталляции это единственный способ купить подписку.
// Оригинал остаётся экспертному режиму нетронутым.
//
