...
//
// ⚠️ КОПИЯ апстримного
// `src/components/subscription/purchase/TariffPurchaseForm.tsx` БЕЗ
// изменений (задача #29): правлены только пути импортов под alias
// `@/`. Спека владельца на экране покупки трогает единственный блок —
// виджет промо-группы в витрине тарифов. Оригинал остаётся
