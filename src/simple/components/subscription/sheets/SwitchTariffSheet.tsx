...
//
// ⚠️ КОПИЯ апстримного
// `src/components/subscription/sheets/SwitchTariffSheet.tsx` БЕЗ
// изменений (задача #29): правлены только пути импортов под alias
// `@/`. Импортировать оригинал простому режиму нельзя — граница
// гейта `scripts/check-mode-boundaries.mjs`.
//
