...
export function ModeAffordance() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[calc(88px+env(safe-area-inset-bottom,0px))] left-4 z-[60] rounded-full border border-dark-700/40 bg-dark-900/80 px-3 py-1.5 text-xs text-dark-200 backdrop-blur transition-colors hover:text-white lg:bottom-4"
    >
      {t('mode.toSimple')}
    </button>
  );
